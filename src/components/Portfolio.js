...
export default function Portfolio() {
  const projects = [
    ...
    { id: 5, title: "ebeauty", description: "Fully Website Redesign", image: "/assets/images/eb.webp", technologies: ["HTML", "CSS", "JavaScript"], liveUrl: "https://www.ebeautyprofessional.com/", githubUrl: "#", featured: true},
                ...
                <article key={project.id} className="col-span-1">
                  <div className="group relative rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                    <div className="relative h-66">
                      <Image src={project.image} alt={project.title} width={600} height={400} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                        ...
                        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-white bg-cyan-500 px-4 py-2 rounded-lg w-fit hover:bg-cyan-600 transition-colors">
