        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-10 grid grid-cols-3 divide-x divide-slate-100 border border-slate-100 rounded-xl overflow-hidden bg-slate-50">
            <div className="px-5 py-4">
              ...
              <p className="text-xs text-slate-700 leading-relaxed">Digital Consumer Experience<br />Content Management</p>
            </div>
            <div className="px-5 py-4">
              <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-400 mb-1.5">Tech</p>
              <p className="text-xs text-slate-700 leading-relaxed">Sitecore · Crownpeak<br />HTML · CSS</p>
            </div>
            <div className="px-5 py-4">
              <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-400 mb-1.5">Type</p>
              <p className="text-xs text-slate-700 leading-relaxed">Enterprise CMS<br />Implementation</p>
            </div>
          </div>
          ...
          <div className="space-y-12 text-sm md:text-base leading-relaxed text-slate-600">
            ...
            <div className="grid md:grid-cols-2 gap-0 border border-slate-100 rounded-xl overflow-hidden">
              <div className="p-7 md:border-r border-slate-100">
                ...
                <p className="text-sm text-slate-500 leading-relaxed mb-3">
                  Advocate Health and its affiliated healthcare brands including Advocate Aurora Health Care, Aurora Health Care, Advocate Children’s, and Aurora BayCare required scalable, component-driven digital experiences across a shared enterprise CMS platform.
                </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Managed content implementation and page updates across Advocate Health Care, Aurora Health Care, Advocate Children's, and Aurora BayCare properties.",
                  "Worked within structured enterprise CMS workflows to support scalable content management and efficient page assembly.",
                  "Coordinated updates, QA feedback, and content revisions with cross-functional teams including design, QA, marketing, and project stakeholders.",
                  "Supported ongoing website maintenance, campaign launches, and production updates within a large enterprise healthcare environment.",
                ].map((item, i) => (
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 rounded-xl border border-slate-100 bg-slate-50 px-7 py-6">
              <p className="text-sm text-slate-500 max-w-md leading-relaxed">
                Explore the Advocate Health digital experience — an enterprise-scale healthcare platform built on component-driven CMS architecture.
              </p>
              <a
